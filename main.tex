...
\label{ssec:fuzzy_neurons}
\input{./tex_files/fuzzy_neurons.tex}

\subsection{Fuzzy neural networks}
\input{./tex_files/fuzzy_networks.tex}

\subsection{Fuzzy neural networks classification}
\input{./tex_files/fnn_connections.tex}
